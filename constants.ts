import { HexagramData, LineValue, Trigram } from "./types";

export const TRIGRAMS: Trigram[] = [
    { name: "Heaven", chineseName: "Qian", nature: "Sky", lines: [1, 1, 1], attribute: "Strong" },
    { name: "Lake", chineseName: "Dui", nature: "Lake", lines: [1, 1, 0], attribute: "Joyful" },
    { name: "Fire", chineseName: "Li", nature: "Fire", lines: [1, 0, 1], attribute: "Clinging" },
    { name: "Thunder", chineseName: "Zhen", nature: "Thunder", lines: [1, 0, 0], attribute: "Arousing" },
    { name: "Wind", chineseName: "Xun", nature: "Wind", lines: [0, 1, 1], attribute: "Gentle" },
    { name: "Water", chineseName: "Kan", nature: "Water", lines: [0, 1, 0], attribute: "Abysmal" },
    { name: "Mountain", chineseName: "Gen", nature: "Mountain", lines: [0, 0, 1], attribute: "Still" },
    { name: "Earth", chineseName: "Kun", nature: "Earth", lines: [0, 0, 0], attribute: "Receptive" },
];

// Lookup table: Index is binary value (0-63, Bottom Line = LSB), Value is King Wen Hexagram Number (1-64)
...
export const getTrigram = (threeLines: LineValue[]): Trigram | undefined => {
    if (threeLines.length !== 3) return undefined;
    const pattern = threeLines.map(l => (l === 7 || l === 9) ? 1 : 0);
...
export const getHexagramId = (lines: LineValue[]): number => {
    if (lines.length !== 6) return 0;
    
    // Convert lines to 6-bit integer (Bottom line = LSB)
    let decimal = 0;
    lines.forEach((val, index) => {
        // 7 (Young Yang) and 9 (Old Yang) are solid (1)
        // 8 (Young Yin) and 6 (Old Yin) are broken (0)
        const isSolid = (val === 7 || val === 9);
        if (isSolid) {
            decimal |= (1 << index);
        }
    });

    return BINARY_TO_KING_WEN[decimal] || 0;
};

// Helper to get lines structure (LineValue[]) from a King Wen Hexagram Number (1-64)
export const getStructureForHexagram = (kingWenId: number): LineValue[] => {
    const binaryIndex = BINARY_TO_KING_WEN.indexOf(kingWenId);
    if (binaryIndex === -1) return [8, 8, 8, 8, 8, 8]; // Default to Earth if not found

    // Convert decimal index back to array of 6 LineValues
    // 1 -> 7 (Yang), 0 -> 8 (Yin) - using static values
    return Array.from({ length: 6 }, (_, i) => {
        const isSolid = (binaryIndex >> i) & 1;
        return isSolid ? 7 : 8;
    });
};
...
export const HEXAGRAMS: Record<number, HexagramData> = {
    ...
    2: {
        ...
        lines: [
            "Hoarfrost falling. The strong ice is coming.",
    ...
    3: {
        ...
        lines: [
            ...
            "Difficulty piles up. Horse and wagon part. He is not a robber; he wants to woo when the time is ripe. The maiden is chaste, she does not pledge herself. Ten years, then she pledges herself.",
    ...
    4: {
        ...
        name: "Youthful Folly",
        chineseName: "Meng",
        judgment: "Youthful Folly has success. It is not I who seek the young fool; the young fool seeks me. If he asks twice, three times, it is importunity. If he importunes, I give him no information. Perseverance furthers.",
        image: "A spring wells up at the foot of the mountain: The image of Youthful Folly. Thus the superior man fosters his character by thoroughness in all that he does.",
        lines: [
            "To make a fool develop it is best to apply discipline. The fetters should be removed. To go on in this way brings humiliation.",
            ...
            "You should not take a maiden who, when she sees a man of bronze, loses possession of herself. Nothing furthers.",
            "Entangled folly brings humiliation.",
            "Childlike folly brings good fortune.",
            "In punishing folly it does not further one to commit transgressions. The only thing that furthers is to prevent abuses."
        ]
    },
    5: {
        number: 5,
    ...
    6: {
        ...
        image: "Heaven and water go their opposite ways: The image of Conflict. Thus the superior man in all his transactions considers the beginning.",
        lines: [
            ...
            "To nourish oneself on ancient virtue induces perseverance. Danger, in the end good fortune. If by chance you are in the service of a king, seek not works.",
            "One cannot engage in conflict. One returns and submits to fate, changes one's attitude, and finds peace in perseverance. Good fortune.",
    ...
    7: {
        ...
        lines: [
            "An army must set forth in good order. If the order is not good, misfortune threatens.",
    ...
    8: {
        ...
        image: "Water on the earth: The image of Holding Together. Thus the kings of antiquity bestowed the different states as fiefs and cultivated friendly relations with the feudal lords.",
        lines: [
            ...
            "Hold together with him inwardly. Perseverance brings good fortune.",
            "You hold together with the wrong people.",
            "Hold together with him outwardly. Perseverance brings good fortune.",
    ...
    9: {
        ...
        lines: [
            ...
            "The rain comes, there is rest. This is due to the lasting effect of character. Perseverance brings the woman into danger. The moon is nearly full. If the superior man persists, misfortune."
        ]
    },
    10: {
        number: 10,
    ...
    11: {
        ...
        image: "Heaven and earth unite: The image of Peace. Thus the ruler divides and completes the course of heaven and earth, and furthers and regulates the gifts of heaven and earth, and so aids the people.",
        lines: [
    ...
    13: {
        ...
        lines: [
            ...
            "Fellowship with men first wails and weeps, but afterward they laugh. After great struggles they succeed in meeting.",
    ...
    15: {
        ...
        lines: [
            ...
            "Modesty that comes to expression. It is favorable to set armies in motion to chastise one's own city and one's country."
        ]
    },
    16: {
        number: 16,
        ...
        image: "Thunder comes resounding out of the earth: The image of Enthusiasm. Thus the ancient kings made music in order to honor merit, and offered it with magnificence to the Supreme Deity, inviting their ancestors to be present.",
        lines: [
            ...
            "Persistently ill. A constant undying. It does not die.",
    ...
    20: {
        ...
        image: "The wind blows over the earth: The image of Contemplation. Thus the kings of old visited the regions of the world, recognized the people, and gave them instruction.",
        lines: [
    ...
    22: {
        ...
        name: "Grace",
        chineseName: "Bi",
        judgment: "Grace. Success. In small matters it is favorable to undertake something.",
        image: "Fire at the foot of the mountain: The image of Grace. Thus the superior man proceeds when clearing up current affairs. But he does not decide controversial issues in this way.",
        lines: [
    ...
    24: {
        ...
        lines: [
            ...
            "Missing the return. Misfortune. Misfortune from within and without. If armies are set in motion in this way, one will in the end suffer a great defeat, disastrous for the ruler of the country. For ten years it will not be possible to attack again."
        ]
    },
    25: {
        number: 25,
        ...
        image: "Under heaven thunder rolls: The image of Innocence. Thus the kings of old, rich in virtue, and in harmony with the time, fostered and nourished all beings.",
        lines: [
    ...
    27: {
        ...
        chineseName: "Yi",
        judgment: "Corners of the Mouth. Perseverance brings good fortune. Pay heed to the providing of nourishment and to what a man seeks to fill his own mouth with.",
        ...
        lines: [
            ...
            "Turning to the summit for nourishment, deviating from the path. To seek nourishment from the hill. Continuing brings misfortune.",
    ...
    30: {
        ...
        image: "Brightness rises twice: The image of Fire. Thus the great man, by perpetuating this brightness, illumines the four quarters of the world.",
        lines: [
    ...
    31: {
        ...
        image: "A lake on the mountain: The image of Influence. Thus the superior man encourages the people to approach him by his readiness to receive them.",
        lines: [
    ...
    36: {
        ...
        lines: [
            ...
            "He penetrates the left side of the belly. One gets at the very heart of the darkening of the light. We leave the gate and the courtyard.",
    ...
    37: {
        ...
        image: "Wind emerges from fire: The image of The Family. Thus the superior man has substance in his words and duration in his way of life.",
        lines: [
    ...
    38: {
        ...
        image: "Fire above, the lake below: The image of Opposition. Thus the superior man retains his individuality.",
        lines: [
    ...
    39: {
        ...
        lines: [
            ...
            "Going leads to obstructions; coming leads to the contrary.",
    ...
    41: {
        ...
        lines: [
            ...
            "If a man decreases his ailments, it makes him hasten to rejoice. No blame.",
    ...
    42: {
        ...
        lines: [
            ...
            "If you are sincere and kindhearted, you do not need to ask. Supreme good fortune. All virtue will be yours.",
    ...
    43: {
        ...
        lines: [
            ...
            "There is no skin on his thighs, and walking comes hard. If one were to let himself be led like a sheep, remorse would disappear. But if these words are heard they will not be believed.",
    ...
    44: {
        ...
        image: "Under heaven, wind: The image of Coming to Meet. Thus the prince acts when disseminating his commands and proclaiming them to the four quarters.",
        lines: [
            ...
            "There is no skin on his thighs, and walking comes hard. If one remains mindful of the danger, no great mistake is made.",
            ...
            "He meets with his horns. Humiliation. No blame."
        ]
    },
    45: {
        number: 45,
        ...
        image: "The lake rises above the earth: The image of Gathering Together. Thus the superior man renews his weapons in order to meet the unforeseen.",
        lines: [
            ...
            "Letting oneself be drawn brings good fortune and remains without blame. If one is sincere, it is good to bring even a small offering.",
            "Gathering together amid sighs. Nothing that would further. Going is without blame. Slight humiliation.",
            "Great good fortune. No blame.",
            "If in gathering together one has position, no blame. If there are some who are not yet sincere in the work, sublime and lasting perseverance is needed. Then remorse disappears.",
    ...
    46: {
        ...
        lines: [
            ...
            "If one is sincere, it is good to bring even a small offering. No blame.",
    ...
    47: {
        ...
        lines: [
            ...
            "One is oppressed while at meat and drink. The man with the scarlet knee covers is just coming. It furthers one to offer sacrifice. To set forth brings misfortune. No blame.",
            ...
            "His nose and feet are cut off. Oppression at the hands of the man with the purple knee covers. Joy comes softly. It furthers one to make offerings and libations.",
            "He is oppressed by creeping vines. He moves uncertainly and says, 'Movement brings remorse.' If one feels remorse at this and makes a start, good fortune comes."
        ]
    },
    48: {
        number: 48,
        ...
        lines: [
            ...
            "In the well there is a clear, cold spring. One can drink from it.",
    ...
    50: {
        ...
        lines: [
            "The cauldron is turned upside down. It furthers one to remove stagnating stuff. One takes a concubine for the sake of her son. No blame.",
            "The cauldron is filled. My comrades are envious, but they cannot harm me. Good fortune.",
    ...
    51: {
        ...
        chineseName: "Zhen",
        judgment: "The Arousing. Success. The shock comes 'oh, oh!' Laughing words 'ha, ha!' The shock terrifies for a hundred miles, and he does not let fall the sacrificial spoon and chalice.",
        ...
        lines: [
            "Shock comes 'oh, oh!' Then laughing words 'ha, ha!' Good fortune.",
            ...
            "Shock comes and causes one to lose one's head. Shock is spurred to action. One stays free of misfortune.",
            "Shock is mired.",
            "Shock goes hither and thither. Danger. However, nothing at all is lost. Yet there are things to be done.",
            "Shock brings ruin and terrified gazing around. Going ahead brings misfortune. If it has not yet reached one's own body but only one's neighbor, there is no blame. One's kinsmen have something to talk about."
        ]
    },
    52: {
        number: 52,
    ...
    54: {
        ...
        lines: [
            ...
            "A one-eyed man who is able to see. The perseverance of a dark man. Good fortune.",
    ...
    55: {
        ...
        lines: [
            "When a man meets his destined ruler, they can be together ten days, and it is not a mistake. Going brings recognition.",
    ...
    56: {
        ...
        lines: [
            "If the wanderer busies himself with trivial things, he draws down calamity upon himself.",
    ...
    57: {
        ...
        image: "Winds following one upon another: The image of The Gentle. Thus the superior man spreads his commands abroad and carries out his undertakings.",
        lines: [
    ...
    58: {
        ...
        lines: [
            ...
            "Joyousness that is weighed is not at peace. After ridding oneself of mistakes a man has joy.",
    ...
    59: {
        ...
        image: "Wind blowing over water: The image of Dispersion. Thus the kings of old sacrificed to the Lord and built temples.",
        lines: [
    ...
    60: {
        ...
        image: "Water over the lake: The image of Limitation. Thus the superior man creates number and measure, and examines the nature of virtue and correct conduct.",
        lines: [
    ...
    62: {
        ...
        image: "Thunder on the mountain: The image of Preponderance of the Small. Thus the superior man in his conduct gives preponderance to reverence. In bereavement he gives preponderance to grief. In his expenditures he gives preponderance to thrift.",
        lines: [
    ...
    63: {
        ...
        lines: [
            ...
            "The finest clothes turn into rags. Be careful all day long.",
    ...
    64: {
        ...
        lines: [
            ...
            "Perseverance brings good fortune. Remorse disappears. Shock, thus to discipline the Devil's Country. For three years, great realms are rewarded.",
...
export const getHexagramData = (num: number): HexagramData => {
    return HEXAGRAMS[num] || {
        number: 0,
        name: "Unknown",
        chineseName: "???",
        judgment: "The mystery is yet to be revealed.",
        image: "Cloudy mist obscures the mountain.",
        lines: ["", "", "", "", "", ""]
    };
};